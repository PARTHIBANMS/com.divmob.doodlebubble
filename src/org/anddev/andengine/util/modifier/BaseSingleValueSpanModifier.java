  ...
  extends BaseDurationModifier<T>
{
  ...
  {
    this(paramFloat1, paramFloat2, paramFloat3, paramIModifierListener, IEaseFunction.DEFAULT);
  }
  ...
  {
    float f = this.mEaseFunction.getPercentage(getSecondsElapsed(), this.mDuration);
