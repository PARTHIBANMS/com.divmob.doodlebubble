  ...
  implements IUpdateHandler
{
  ...
  public boolean isLineVisible(Line paramLine)
  {
    return RectangularShapeCollisionChecker.isVisible(this, paramLine);
  }
  
  public boolean isRectangularShapeVisible(RectangularShape paramRectangularShape)
  {
    return RectangularShapeCollisionChecker.isVisible(this, paramRectangularShape);
  }
  ...
  public void onApplySceneBackgroundMatrix(GL10 paramGL10)
  {
    GLHelper.setProjectionIdentityMatrix(paramGL10);
    float f1 = getWidthRaw();
    float f2 = getHeightRaw();
  ...
  public void onApplySceneMatrix(GL10 paramGL10)
  {
    GLHelper.setProjectionIdentityMatrix(paramGL10);
  ...
  public void setChaseEntity(IEntity paramIEntity)
  {
    this.mChaseEntity = paramIEntity;
  }
  ...
  public void updateChaseEntity()
  {
    ...
    {
      float[] arrayOfFloat = this.mChaseEntity.getSceneCenterCoordinates();
