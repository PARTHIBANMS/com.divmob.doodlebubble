...
public class Engine
  implements SensorEventListener, LocationListener, View.OnTouchListener, ITouchController.ITouchEventCallback, TimeConstants
{
  ...
  {
    SensorManager localSensorManager = (SensorManager)paramContext.getSystemService("sensor");
    if ((isSensorSupported(localSensorManager, 1)) && (isSensorSupported(localSensorManager, 2)))
    {
      unregisterSelfAsSensorListener(localSensorManager, 1);
      unregisterSelfAsSensorListener(localSensorManager, 2);
      return true;
    }
    return false;
  }
  ...
  public boolean enableAccelerometerSensor(Context paramContext, IAccelerometerListener paramIAccelerometerListener, AccelerometerSensorOptions paramAccelerometerSensorOptions)
  {
    ...
    if (isSensorSupported(localSensorManager, 1))
    {
      ...
      if (this.mAccelerometerData == null) {
        this.mAccelerometerData = new AccelerometerData(((WindowManager)paramContext.getSystemService("window")).getDefaultDisplay().getOrientation());
      }
  ...
  public boolean enableOrientationSensor(Context paramContext, IOrientationListener paramIOrientationListener, OrientationSensorOptions paramOrientationSensorOptions)
  {
    ...
    if ((isSensorSupported(localSensorManager, 1)) && (isSensorSupported(localSensorManager, 2)))
    {
      ...
      if (this.mOrientationData == null) {
        this.mOrientationData = new OrientationData(((WindowManager)paramContext.getSystemService("window")).getDefaultDisplay().getOrientation());
      }
      registerSelfAsSensorListener(localSensorManager, 1, paramOrientationSensorOptions.getSensorDelay());
      registerSelfAsSensorListener(localSensorManager, 2, paramOrientationSensorOptions.getSensorDelay());
      return true;
    }
    return false;
  }
  ...
  public void onAccuracyChanged(Sensor paramSensor, int paramInt)
  {
    ...
    case 1: 
      ...
      } while (this.mOrientationData == null);
      this.mOrientationData.setAccelerometerAccuracy(paramInt);
      this.mOrientationListener.onOrientationChanged(this.mOrientationData);
      return;
    }
    this.mOrientationData.setMagneticFieldAccuracy(paramInt);
    this.mOrientationListener.onOrientationChanged(this.mOrientationData);
  }
  ...
  public void onLoadComplete(Scene paramScene)
  {
    setScene(paramScene);
  }
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    ...
    case 1: 
      ...
      this.mOrientationData.setAccelerometerValues(paramSensorEvent.values);
      this.mOrientationListener.onOrientationChanged(this.mOrientationData);
      return;
    }
    this.mOrientationData.setMagneticFieldValues(paramSensorEvent.values);
    this.mOrientationListener.onOrientationChanged(this.mOrientationData);
  }
