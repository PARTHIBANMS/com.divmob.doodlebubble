  ...
  implements Scene.IOnAreaTouchListener, Scene.IOnSceneTouchListener
{
  ...
  {
    prepareAnimations();
    float f1 = this.mCamera.getWidthRaw();
    float f2 = this.mCamera.getHeightRaw();
    this.mMenuAnimator.buildAnimations(this.mMenuItems, f1, f2);
  }
  ...
  public void prepareAnimations()
  {
    float f1 = this.mCamera.getWidthRaw();
    float f2 = this.mCamera.getHeightRaw();
    this.mMenuAnimator.prepareAnimations(this.mMenuItems, f1, f2);
  }
