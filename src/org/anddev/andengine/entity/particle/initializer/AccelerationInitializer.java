  ...
  extends BaseDoubleValueInitializer
{
  ...
  {
    paramParticle.getPhysicsHandler().accelerate(paramFloat1, paramFloat2);
  }
 ...
 * Qualified Name:     org.anddev.andengine.entity.particle.initializer.AccelerationInitializer
