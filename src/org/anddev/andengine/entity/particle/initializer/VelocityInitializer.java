  ...
  extends BaseDoubleValueInitializer
{
  ...
  {
    paramParticle.getPhysicsHandler().setVelocity(paramFloat1, paramFloat2);
  }
 ...
 * Qualified Name:     org.anddev.andengine.entity.particle.initializer.VelocityInitializer
