  ...
  extends Font
{
  ...
  public StrokeFont(ITexture paramITexture, Typeface paramTypeface, float paramFloat1, boolean paramBoolean, int paramInt1, float paramFloat2, int paramInt2)
  {
    this(paramITexture, paramTypeface, paramFloat1, paramBoolean, paramInt1, paramFloat2, paramInt2, false);
  }
  
  public StrokeFont(ITexture paramITexture, Typeface paramTypeface, float paramFloat1, boolean paramBoolean1, int paramInt1, float paramFloat2, int paramInt2, boolean paramBoolean2)
  {
    super(paramITexture, paramTypeface, paramFloat1, paramBoolean1, paramInt1);
