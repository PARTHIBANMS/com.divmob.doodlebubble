  ...
  implements LevelConstants
{
    ...
    throws IOException
  {
    try
    {
      ...
      onBeforeLoadLevel();
      localXMLReader.setContentHandler(new LevelParser(this.mDefaultEntityLoader, this.mEntityLoaders));
    ...
    {
      StreamUtils.close(paramInputStream);
    }
  }
  ...
  public void setDefaultEntityLoader(IEntityLoader paramIEntityLoader)
  {
