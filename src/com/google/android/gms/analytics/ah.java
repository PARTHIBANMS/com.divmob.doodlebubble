  ...
  implements n
{
  ...
  private void a(ab paramab, URL paramURL, boolean paramBoolean)
  {
    ...
    //   0	272	0	this	ah
    //   0	272	1	paramab	ab
    //   0	272	2	paramURL	URL
    //   0	272	3	paramBoolean	boolean
    //   26	242	4	localURL	URL
    //   50	64	5	localHttpHost	HttpHost
    //   226	32	6	localIOException	IOException
    //   201	1	7	localClientProtocolException	ClientProtocolException
    //   65	51	8	localHttpEntityEnclosingRequest	HttpEntityEnclosingRequest
    //   122	58	9	localHttpResponse	HttpResponse
    //   136	29	10	i	int
    //   145	8	11	localHttpEntity	HttpEntity
    //   223	1	12	localMalformedURLException	MalformedURLException
    // Exception table:
    //   from	to	target	type
