  ...
  public static class Builder
  {
    ...
    public Intent getIntent()
    {
      ...
      if ((this.Rc != null) && (this.Rc.size() > i))
      {
        ...
        int n = i;
        label59:
        er.a(n, "Call-to-action buttons are only available for URLs.");
        if ((bool2) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL"))) {
          break label308;
        }
        int i2 = i;
        label86:
        er.a(i2, "The content URL is required for interactive posts.");
        ...
        label122:
        er.a(i, "Must set content URL or content deep-link ID to use a call-to-action button.");
