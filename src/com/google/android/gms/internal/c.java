...
public abstract interface c
{
    ...
    extends ka<b>
  {
            ...
            do
            {
              ...
              do
              {
                ...
                do
                {
                  ...
                  bool3 = kc.equals(this.eS, localb.eS);
                  bool2 = false;
                } while (!bool3);
                i = this.eT;
                j = localb.eT;
    ...
    public int hashCode()
    {
      ...
      label103:
      label110:
      for (int i1 = 0;; i1 = this.aae.hashCode())
      {
        return i1 + n;
        k = 1237;
        break;
    ...
    extends ka<c>
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      {
        String str;
        boolean bool3 = this.eY < localc.eY;
        bool2 = false;
        if (bool3) {
          break;
        }
        boolean bool4 = this.eZ < localc.eZ;
        bool2 = false;
        if (bool4) {
          break;
        }
        boolean bool5 = this.fa;
        boolean bool6 = localc.fa;
        bool2 = false;
        if (bool5 != bool6) {
          break;
        }
        boolean bool7 = this.fb < localc.fb;
        bool2 = false;
        if (bool7) {
          break;
        }
        ...
        if (localc.aae != null)
        {
          boolean bool8 = localc.aae.isEmpty();
          bool2 = false;
          if (!bool8) {
            break;
          }
      ...
      return false;
      label191:
      return this.aae.equals(localc.aae);
    }
        ...
        do
        {
          ...
          do
          {
            ...
            do
            {
              ...
              bool3 = kc.equals(this.fc, locald.fc);
              bool2 = false;
            } while (!bool3);
            bool4 = kc.equals(this.fd, locald.fd);
            bool2 = false;
          } while (!bool4);
          bool5 = kc.equals(this.fe, locald.fe);
          bool2 = false;
        } while (!bool5);
        if ((this.aae != null) && (!this.aae.isEmpty())) {
          break label137;
    ...
    extends ka<f>
  {
    ...
    public boolean equals(Object paramObject)
    {
                          ...
                          do
                          {
                            ...
                            do
                            {
                              ...
                              do
                              {
                                ...
                                bool3 = kc.equals(this.fg, localf.fg);
                                bool2 = false;
                              } while (!bool3);
                              bool4 = kc.equals(this.fh, localf.fh);
                              bool2 = false;
                            } while (!bool4);
                            bool5 = kc.equals(this.fi, localf.fi);
                            bool2 = false;
                          } while (!bool5);
                          bool6 = kc.equals(this.fj, localf.fj);
                          bool2 = false;
                        } while (!bool6);
                        bool7 = kc.equals(this.fk, localf.fk);
                        bool2 = false;
                      } while (!bool7);
                      bool8 = kc.equals(this.fl, localf.fl);
                      bool2 = false;
                    } while (!bool8);
                    bool9 = kc.equals(this.fm, localf.fm);
                    bool2 = false;
                  } while (!bool9);
                  bool10 = kc.equals(this.fn, localf.fn);
                  bool2 = false;
                } while (!bool10);
                if (this.fo != null) {
                  break;
      ...
      {
        c.a locala;
        int i = Float.floatToIntBits(this.ft);
        int j = Float.floatToIntBits(localf.ft);
        bool2 = false;
        if (i != j) {
          break;
        }
        boolean bool11 = this.fu;
        boolean bool12 = localf.fu;
        bool2 = false;
        if (bool11 != bool12) {
          break;
        }
        boolean bool13 = kc.equals(this.fv, localf.fv);
        bool2 = false;
        if (!bool13) {
          break;
        }
        ...
        if (localf.aae != null)
        {
          boolean bool14 = localf.aae.isEmpty();
          bool2 = false;
          if (!bool14) {
            break;
          }
      ...
      return false;
      label525:
      return this.aae.equals(localf.aae);
    }
                      ...
                      do
                      {
                        ...
                        do
                        {
                          ...
                          do
                          {
                            ...
                            bool3 = kc.equals(this.fy, localg.fy);
                            bool2 = false;
                          } while (!bool3);
                          bool4 = kc.equals(this.fz, localg.fz);
                          bool2 = false;
                        } while (!bool4);
                        bool5 = kc.equals(this.fA, localg.fA);
                        bool2 = false;
                      } while (!bool5);
                      bool6 = kc.equals(this.fB, localg.fB);
                      bool2 = false;
                    } while (!bool6);
                    bool7 = kc.equals(this.fC, localg.fC);
                    bool2 = false;
                  } while (!bool7);
                  bool8 = kc.equals(this.fD, localg.fD);
                  bool2 = false;
                } while (!bool8);
                bool9 = kc.equals(this.fE, localg.fE);
                bool2 = false;
              } while (!bool9);
              bool10 = kc.equals(this.fF, localg.fF);
              bool2 = false;
            } while (!bool10);
            bool11 = kc.equals(this.fG, localg.fG);
            bool2 = false;
          } while (!bool11);
          bool12 = kc.equals(this.fH, localg.fH);
          bool2 = false;
        } while (!bool12);
        if ((this.aae != null) && (!this.aae.isEmpty())) {
          break label284;
        ...
        do
        {
          ...
          do
          {
            ...
            do
            {
                ...
                do
                {
                  ...
                  do
                  {
                    ...
                    do
                    {
                      ...
                      bool3 = kc.equals(this.fK, localh.fK);
                      bool2 = false;
                    } while (!bool3);
                    bool4 = kc.equals(this.fL, localh.fL);
                    bool2 = false;
                  } while (!bool4);
                  bool5 = kc.equals(this.fM, localh.fM);
                  bool2 = false;
                } while (!bool5);
                i = this.fN;
                j = localh.fN;
              ...
              bool6 = kc.equals(this.fO, localh.fO);
              bool2 = false;
            } while (!bool6);
            k = this.fP;
            m = localh.fP;
    ...
    public boolean equals(Object paramObject)
    {
      ...
      for (;;)
      {
        if ((this.aae == null) || (this.aae.isEmpty()))
        {
          if (locali.aae != null)
          {
            boolean bool3 = locali.aae.isEmpty();
            bool2 = false;
            if (!bool3) {
              break;
            }
          ...
          return false;
          label171:
          if (!this.fT.equals(locali.fT)) {
            return false;
          }
        }
      }
      return this.aae.equals(locali.aae);
    }
    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          do
          {
            ...
            bool3 = kc.equals(this.fU, localj.fU);
            bool2 = false;
          } while (!bool3);
          if (this.fV != null) {
            break;
      ...
      for (;;)
      {
        if ((this.aae == null) || (this.aae.isEmpty()))
        {
          if (localj.aae != null)
          {
            boolean bool4 = localj.aae.isEmpty();
            bool2 = false;
            if (!bool4) {
              break;
            }
          ...
          return false;
          label154:
          if (!this.fW.equals(localj.fW)) {
            return false;
          }
        }
      }
      return this.aae.equals(localj.aae);
    }
