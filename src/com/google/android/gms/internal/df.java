  ...
  extends WebChromeClient
{
  ...
  {
    paramBuilder.setMessage(paramString).setPositiveButton(17039370, new df.3(paramJsResult)).setNegativeButton(17039360, new df.2(paramJsResult)).setOnCancelListener(new df.1(paramJsResult)).create().show();
  }
  ...
  private static void a(Context paramContext, AlertDialog.Builder paramBuilder, String paramString1, String paramString2, JsPromptResult paramJsPromptResult)
  {
    ...
    paramBuilder.setView(localLinearLayout).setPositiveButton(17039370, new df.6(paramJsPromptResult, localEditText)).setNegativeButton(17039360, new df.5(paramJsPromptResult)).setOnCancelListener(new df.4(paramJsPromptResult)).create().show();
  }
