...
{
  RemoteMediaPlayer$4(RemoteMediaPlayer paramRemoteMediaPlayer, GoogleApiClient paramGoogleApiClient, JSONObject paramJSONObject) {}
  ...
  protected void a(dq paramdq)
  {
    synchronized (RemoteMediaPlayer.c(this.xk))
    {
      ...
      try
      {
        RemoteMediaPlayer.e(this.xk).b(this.xy, this.xp);
      }
