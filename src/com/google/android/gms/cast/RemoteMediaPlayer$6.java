...
{
  RemoteMediaPlayer$6(RemoteMediaPlayer paramRemoteMediaPlayer, GoogleApiClient paramGoogleApiClient, long paramLong, int paramInt, JSONObject paramJSONObject) {}
  ...
  protected void a(dq paramdq)
  {
    synchronized (RemoteMediaPlayer.c(this.xk))
    {
      ...
      try
      {
        RemoteMediaPlayer.e(this.xk).a(this.xy, this.xq, this.xr, this.xp);
      }
