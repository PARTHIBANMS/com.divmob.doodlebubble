...
class b
  extends Sprite
{
  b(MBaseGameActivity paramMBaseGameActivity, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, TextureRegion paramTextureRegion)
  {
 ...
 * Qualified Name:     com.divmob.maegame.game.b
